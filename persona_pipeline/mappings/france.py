...
MAPPINGS = CountryMappings(
    ...
    region_keywords={
        ...
        "Hauts-de-France": ["lille", "nord", "calais", "hauts-de-france"],
        "Provence-Alpes-Côte d'Azur": ["marseille", "nice", "provence", "paca", "côte d'azur"],
        "Nouvelle-Aquitaine": ["bordeaux", "aquitaine"],
        "Occitanie": ["toulouse", "montpellier", "occitanie"],
        "Pays de la Loire": ["nantes", "loire-atlantique"],
        "Bretagne": ["rennes", "brest", "bretagne", "breton"],
        "Normandie": ["rouen", "caen", "normandie"],
        "Grand Est": ["strasbourg", "metz", "alsace", "lorraine", "grand est"],
        "Bourgogne-Franche-Comté": ["dijon", "bourgogne", "franche-comté"],
        "Centre-Val de Loire": ["orléans", "tours", "centre-val"],
        "Corse": ["corse", "ajaccio", "bastia"],
        "Outre-mer": ["réunion", "guadeloupe", "martinique", "outre-mer"],
    },
    age_gen_keywords={
        "jeune": ["jeune", "jeunesse", "20 ans", "30 ans"],
        "adulte": ["adulte", "âge moyen", "40 ans", "50 ans"],
        "âgé": ["âgé", "vieux", "vieille", "senior", "60 ans", "70 ans"],
    },
    sex_keywords={
        "Homme": ["homme", "masculin", "garçon"],
        "Femme": ["femme", "féminin", "fille"],
    },
